...
посредством функции main_cycle в виде параметра target_status_id, успешные 
запросы помечаются значением параметра success_status_id который так же
...
считываются и преобразуются в необходимые форматы
...
Для работы программы требуется наличие базы данных со структурой, 
